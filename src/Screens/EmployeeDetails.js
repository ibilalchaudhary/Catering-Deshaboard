...
export default function EmployeeDetails({ setIsSmallNav }) {
  useEffect(() => {
    setIsSmallNav(false);
  }, []);
    ...
    <div className="container">
      <div className="container__header">
        ...
        <div className="container__header__btns">
          <Button label="Edit" path="/dashboard/edit-employee" />
        </div>
      </div>
      <div className="table__container">
        <form className="table__container__wrapper">
          ...
          <div className="table__container__wrapper__content__upload__img__container">
            <div className="table__container__wrapper__content__upload__img__card">
              Profile
              <img
                src={placeholderImg}
                alt="table__container__wrapper__content__upload__img"
              />
            </div>
            <div className="table__container__wrapper__content__upload__img__card">
              CNIC Front
